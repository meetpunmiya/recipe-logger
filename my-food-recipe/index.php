                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h1 class="caption"><strong>Welcome to Delicacy</strong></h1>
                            <p class="caption caption-p">Create delicious delicacies as per your own requirements. ADD,delete,update recipes to ensure a seamless and delightful cooking experience.</p>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="image/bg3.jpg" class="d-block w-100" alt="...">d
                        <div class="carousel-caption d-none d-md-block">
                            <h1 class="caption"><strong>Wish to cook on your own?</strong></h5>
                            <p class="caption caption-p">Like me do you also wish to preparesome mom-like food but cannot remember her recipe? NOT ANYMORE!</p>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="image/bg5.jpg" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                            <h1 class="caption"><strong>Delicacy by Meet jain</strong></h1>
                            <p class="caption caption-p">A recipe logger like never before</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text text-center">This is typically the name of the food the user will be making the recipe.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text text-center">These are the steps the user should take and are numbered in the way they should be done.</p>
                            </div>
                        </div>
                    </div>
                </div>   
